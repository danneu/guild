...
exports.MIN_TOPIC_TITLE_LENGTH =
    parseInt(process.env.MIN_TOPIC_TITLE_LENGTH, 10) || 3
exports.MAX_TOPIC_TITLE_LENGTH =
    parseInt(process.env.MAX_TOPIC_TITLE_LENGTH, 10) || 150
...
exports.LATEST_RPGN_TOPIC_ID =
    parseInt(process.env.LATEST_RPGN_TOPIC_ID) || undefined
exports.LATEST_RPGN_IMAGE_URL = process.env.LATEST_RPGN_IMAGE_URL || undefined

exports.CURRENT_FEEDBACK_TOPIC_ID =
    parseInt(process.env.CURRENT_FEEDBACK_TOPIC_ID, 10) || undefined
...
exports.MAX_CONVO_PARTICIPANTS =
    parseInt(process.env.MAX_CONVO_PARTICIPANTS) || 10
...
exports.RECENT_POSTS_PER_PAGE =
    parseInt(process.env.RECENT_POSTS_PER_PAGE, 10) || 5
...
// For /search endpoint
exports.SEARCH_RESULTS_PER_PAGE =
    parseInt(process.env.SEARCH_RESULTS_PER_PAGE) || 50
